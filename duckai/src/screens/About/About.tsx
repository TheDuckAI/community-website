    ...
    <Layout>
      <div className={styles.container}>
        ...
        <p className={styles.description}>
          ...
          Technology and beyond, driven by our passion for investigating large language models and multimodal systems. Our present endeavors concentrate on the development and analysis of a variety of
